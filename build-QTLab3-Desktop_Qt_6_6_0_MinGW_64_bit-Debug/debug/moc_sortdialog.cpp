...
static constexpr auto qt_meta_stringdata_SortDialog = QtMocHelpers::stringData(
    "SortDialog"
);
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_SortDialog_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_SortDialog_t qt_meta_stringdata_SortDialog = {
    {
...
Q_CONSTINIT static const uint qt_meta_data_SortDialog[] = {
...
Q_CONSTINIT const QMetaObject SortDialog::staticMetaObject = { {
    ...
    qt_meta_stringdata_SortDialog.offsetsAndSizes,
    qt_meta_data_SortDialog,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_SortDialog_t,
        // Q_OBJECT / Q_GADGET
